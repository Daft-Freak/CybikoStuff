...
void or32Test()
{
    ...
    static const TestValue32 tests32[]
    {
        ...
        {0x01234567, 0x89ABCDEF, 0x89ABCDEF, 0x88},
        {0xFFFFFFFF, 0xAAAAAAAA, 0xFFFFFFFF, 0x88},
    };
    static const int numTests32 = sizeof(tests32) / sizeof(tests32[0]);

    int i = 0;
    writeString("OR IMM (32)");
...
void or16Test()
{
    ...
    static const TestValue16 tests16[]
    {
        ...
        {0x1357, 0x9BDF, 0x9BDF, 0x88},
        {0xFFFF, 0xAAAA, 0xFFFF, 0x88},
    };
    static const int numTests16 = sizeof(tests16) / sizeof(tests16[0]);

    int i = 0;
    writeString("OR IMM (16)");
